...
/**
 * Demo assets and repair requests: ~35 assets and ~85 requests in deliberately different situations, all relative to
...
class DemoDataSeeder extends Seeder
{
    ...
    private function scenarios(int $ly): array
    {
        return [
            ...
            // ================= closed, the last six months: what more of the hospital's staff said about the technicians — every one rated
            // with a comment, spread over the months, so each technician's rating page has real "recent comments" and a trend to draw
            ['s' => 'closed', 'age' => 34, 'by' => 'opd2', 'a' => 'PC-OPD-02', 't' => 'Hardware', 'team' => ['it1'], 'cost' => 1200,
                'rate' => [5, 'มาไว ตรวจเช็คทีละจุดและอธิบายให้ฟังด้วย เครื่องไม่ค้างอีกเลย'],
                'title' => 'เครื่องห้องตรวจ 2 ค้างระหว่างบันทึกผล', 'desc' => 'บันทึกผลตรวจค้างกลางคัน ต้องรีสตาร์ทเครื่องวันละหลายครั้ง', 'note' => 'ตรวจพบหน่วยความจำเสื่อม เปลี่ยน RAM และตรวจสอบระบบแล้ว'],
            ['s' => 'closed', 'age' => 58, 'by' => 'adm', 'a' => 'PRN-ADM-01', 't' => 'Hardware', 'team' => ['it1'],
                'rate' => [4, 'แก้ปัญหาได้ตรงจุด เครื่องกลับมาใช้งานได้ปกติภายในวันเดียว'],
                'title' => 'เครื่องพิมพ์ห้องธุรการกระดาษติดบ่อย', 'desc' => 'พิมพ์เอกสารหนังสือราชการแล้วกระดาษติดทุกครั้งที่พิมพ์สองหน้า', 'note' => 'ทำความสะอาดลูกกลิ้งดึงกระดาษและปรับตั้งถาดกระดาษ'],
            ['s' => 'closed', 'age' => 46, 'by' => 'ipd2', 'a' => 'PC-IPD-01', 't' => 'Hardware', 'team' => ['it2'], 'cost' => 2100, 'work' => 2600,
                'rate' => [4, 'รับเรื่องเร็ว แต่ต้องรออะไหล่สองวัน'],
                'title' => 'เครื่องเคาน์เตอร์พยาบาลจอดับเป็นพักๆ', 'desc' => 'จอดับแล้วติดเองทุก 10 นาที ระหว่างบันทึกการพยาบาล', 'note' => 'เปลี่ยนสายสัญญาณภาพและการ์ดจอ ทดสอบใช้งานต่อเนื่อง 2 ชั่วโมง'],
            ['s' => 'closed', 'age' => 100, 'by' => 'adm', 'a' => 'PC-ADM-01', 't' => 'Hardware', 'team' => ['it2'],
                'rate' => [5, 'ทำงานสะอาด เรียบร้อย ไม่รบกวนงานผู้บริหาร'],
                'title' => 'ขยายพื้นที่เก็บข้อมูลเครื่องผู้บริหาร', 'desc' => 'ดิสก์เต็ม เปิดไฟล์ประชุมขนาดใหญ่ไม่ได้', 'note' => 'เพิ่มฮาร์ดดิสก์และย้ายไฟล์เก่าเข้าที่เก็บสำรอง'],
            ['s' => 'closed', 'age' => 40, 'by' => 'opd2', 'a' => 'NET-AP-OPD-01', 't' => 'Network', 'team' => ['net'],
                'rate' => [5, 'สัญญาณครอบคลุมทั้งชั้นแล้ว ขอบคุณมากครับ'],
                'title' => 'Wi-Fi ห้องตรวจฝั่งซ้ายสัญญาณอ่อน', 'desc' => 'แท็บเล็ตห้องตรวจ 4-6 หลุดจาก Wi-Fi บ่อย', 'note' => 'ปรับช่องสัญญาณและกำลังส่ง Access Point ตรวจวัดสัญญาณทุกห้องแล้ว'],
            ['s' => 'closed', 'age' => 88, 'by' => 'ipd2', 'a' => 'NET-AP-IPD-01', 't' => 'Network', 'team' => ['net'], 'work' => 1800,
                'rate' => [3, 'แก้ได้ แต่กลับมาหลุดอีกครั้งหลังผ่านไปสัปดาห์หนึ่ง'],
                'title' => 'เครือข่ายหอผู้ป่วยในหลุดช่วงกลางคืน', 'desc' => 'ช่วงดึกระบบบันทึกทางการพยาบาลเชื่อมต่อไม่ได้เป็นช่วงๆ', 'note' => 'ปรับตั้งค่า VLAN และเปลี่ยนสาย patch ที่ชำรุด'],
            ['s' => 'closed', 'age' => 125, 'by' => 'hr', 't' => 'Network', 'team' => ['net'], 'place' => 'ห้องทรัพยากรบุคคล ชั้น 2',
                'rate' => [4, 'ตั้งค่า Wi-Fi ให้เครื่องใหม่ครบทุกเครื่อง อธิบายวิธีใช้ให้ด้วย'],
                'title' => 'ตั้งค่าเครือข่ายเครื่องใหม่ 4 เครื่อง', 'desc' => 'ได้รับเครื่องคอมพิวเตอร์ใหม่ ขอตั้งค่าเข้าเครือข่ายโรงพยาบาล', 'note' => 'ตั้งค่า IP, โดเมน และสิทธิ์เข้าใช้งานครบทุกเครื่อง'],
            ['s' => 'closed', 'age' => 52, 'by' => 'hr', 't' => 'Software', 'team' => ['dev'], 'place' => 'ห้องทรัพยากรบุคคล ชั้น 2',
                'rate' => [5, 'ช่วยกู้ไฟล์ที่ลบผิดกลับมาได้ครบ ขอบคุณมากค่ะ'],
                'title' => 'ลบโฟลเดอร์ข้อมูลบุคลากรโดยไม่ตั้งใจ', 'desc' => 'ลบโฟลเดอร์ข้อมูลประเมินบุคลากรจากเครื่องกลาง ขอความช่วยเหลือกู้คืน', 'note' => 'กู้คืนจากข้อมูลสำรองประจำวันและตรวจสอบความครบถ้วนกับผู้แจ้ง'],
            ['s' => 'closed', 'age' => 72, 'by' => 'adm', 'a' => 'PC-ADM-01', 't' => 'Software', 'team' => ['dev'],
                'rate' => [5, 'ติดตั้งโปรแกรมเอกสารให้ทั้งฝ่ายเสร็จภายในวันเดียว'],
                'title' => 'ติดตั้งโปรแกรมสารบรรณอิเล็กทรอนิกส์', 'desc' => 'ขอติดตั้งและตั้งค่าโปรแกรมสารบรรณอิเล็กทรอนิกส์สำหรับฝ่ายบริหาร', 'note' => 'ติดตั้งโปรแกรม ตั้งค่าผู้ใช้งาน และสอนวิธีใช้เบื้องต้น'],
            ['s' => 'closed', 'age' => 140, 'by' => 'rad', 't' => 'Software', 'team' => ['dev'], 'place' => 'ห้องแปลผลภาพรังสี', 'work' => 1500,
                'rate' => [4, 'ระบบอ่านภาพกลับมาเร็วกว่าที่คาด แต่ต้องแจ้งซ้ำหนึ่งครั้ง'],
                'title' => 'โปรแกรมดูภาพรังสี (PACS) เปิดภาพช้า', 'desc' => 'เปิดภาพเอกซเรย์แต่ละภาพใช้เวลานานกว่า 30 วินาที', 'note' => 'ล้างแคชและปรับตั้งค่าการเชื่อมต่อกับเซิร์ฟเวอร์ภาพ'],
            ['s' => 'closed', 'age' => 65, 'by' => 'ipd2', 'a' => 'AC-IPD-01', 't' => 'Facilities', 'team' => ['tech1'], 'cost' => 1800,
                'rate' => [4, 'ช่างสุภาพ ล้างแอร์สะอาด ไม่มีน้ำหยดเลอะพื้นหอผู้ป่วย'],
                'title' => 'แอร์หอผู้ป่วยมีน้ำหยด', 'desc' => 'มีน้ำหยดจากแอร์ลงพื้นทางเดินหน้าห้องผู้ป่วย', 'note' => 'ล้างคอยล์เย็น ปรับความลาดเอียงท่อน้ำทิ้ง และเปลี่ยนท่อที่รั่ว'],
            ['s' => 'closed', 'age' => 105, 'by' => 'hr', 't' => 'Facilities', 'team' => ['tech1'], 'place' => 'ห้องประชุมใหญ่ ชั้น 2',
                'rate' => [5, 'ซ่อมไฟห้องประชุมเสร็จก่อนเวลาประชุม ขอบคุณค่ะ'],
                'title' => 'หลอดไฟห้องประชุมดับหลายดวง', 'desc' => 'ไฟห้องประชุมใหญ่ดับครึ่งห้อง มีประชุมคณะกรรมการวันพรุ่งนี้', 'note' => 'เปลี่ยนหลอดไฟและบัลลาสต์ที่เสียครบทุกดวง'],
            ['s' => 'closed', 'age' => 55, 'by' => 'rad', 'a' => 'XRAY-RAD-01', 't' => 'Facilities', 'team' => ['tech2'], 'cost' => 4500,
                'rate' => [5, 'สอบเทียบเครื่องเสร็จตามกำหนด ไม่กระทบคิวผู้ป่วย'],
                'title' => 'สอบเทียบเครื่องเอกซเรย์ดิจิทัลประจำไตรมาส', 'desc' => 'ครบกำหนดตรวจสอบและสอบเทียบเครื่องเอกซเรย์ประจำไตรมาส', 'note' => 'ตรวจสอบค่ารังสีและสอบเทียบเครื่อง ออกใบรับรองผลแล้ว'],
            ['s' => 'closed', 'age' => 155, 'by' => 'rad', 'a' => 'XRAY-RAD-01', 't' => 'Facilities', 'team' => ['tech2'], 'cost' => 12800, 'work' => 6000,
                'rate' => [2, 'รอชิ้นส่วนนานเกินไป คิวเอกซเรย์ค้างหลายวัน อยากให้แจ้งความคืบหน้าบ่อยกว่านี้'],
                'title' => 'หลอดเอกซเรย์ให้ภาพไม่คมชัด', 'desc' => 'ภาพเอกซเรย์เบลอเป็นบางส่วน ต้องถ่ายซ้ำบ่อย', 'note' => 'สั่งชิ้นส่วนจากผู้แทนจำหน่ายและเปลี่ยนให้ พร้อมสอบเทียบใหม่'],
            ['s' => 'closed', 'age' => 130, 'by' => 'opd2', 'a' => 'PC-OPD-03', 't' => 'Hardware', 'team' => ['gone'],
                'rate' => [4, 'ทำงานเรียบร้อย ตรวจเช็คให้ทั้งจุดคัดกรอง'],
                'title' => 'เครื่องจุดคัดกรองเปิดไม่ติดบางวัน', 'desc' => 'เช้าบางวันเปิดเครื่องไม่ติด ต้องถอดปลั๊กแล้วเสียบใหม่', 'note' => 'เปลี่ยนแหล่งจ่ายไฟและตรวจสอบสายไฟทั้งชุด'],
            ['s' => 'closed', 'age' => 115, 'by' => 'fin', 'a' => 'PRN-FIN-01', 't' => 'Hardware', 'team' => ['gone'], 'cost' => 700,
                'rate' => [4, 'ซ่อมแล้วใช้งานได้ปกติ และแนะนำวิธีป้องกันไม่ให้กระดาษติดอีก'],
                'title' => 'เครื่องพิมพ์ใบเสร็จการเงินพิมพ์จาง', 'desc' => 'ใบเสร็จที่พิมพ์ออกมาจางมาก ลูกค้าอ่านตัวเลขไม่ชัด', 'note' => 'เปลี่ยนริบบอนและทำความสะอาดหัวพิมพ์'],
            ['s' => 'closed', 'age' => 170, 'by' => 'ipd2', 'a' => 'PRN-IPD-01', 't' => 'Hardware', 'team' => ['gone'],
                'rate' => [5, 'แก้ปัญหาเครื่องพิมพ์ใบสั่งยาได้เร็ว พยาบาลไม่ต้องรอนาน'],
                'title' => 'เครื่องพิมพ์ใบสั่งยาหัวพิมพ์เสีย', 'desc' => 'ตัวอักษรขาดหายเป็นแถบ อ่านใบสั่งยาไม่ชัด', 'note' => 'เปลี่ยนหัวพิมพ์และทำความสะอาดชุดขับเคลื่อน'],
